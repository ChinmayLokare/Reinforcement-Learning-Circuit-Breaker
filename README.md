...
CircuitBreakerDemo.Core/

A class library containing all the core business logic, services, and the reinforcement learning implementation. It is completely UI-agnostic.

CircuitBreakerDemo.Web/

The Blazor WebAssembly project that contains all UI components, pages, and the main simulation control loop.

CircuitBreakerDemo.Tests/

An xUnit project containing unit tests for the core logic, particularly the Q-learning algorithm and state calculations.
